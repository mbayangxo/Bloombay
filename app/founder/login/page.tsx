  ...
  return (
    ...
    >
      <div className="w-full max-w-sm">
        ...
        <MagicLinkCallback portal="founder" onError={setMagicError} />
        ...
        <p className="text-center mt-5 text-sm" style={{ color: "#6a3a5a" }}>
          <Link href="/portals" className="underline hover:opacity-80">
            Other portals
          </Link>
        </p>

        <div className="mt-6 flex items-center justify-center gap-2" style={{ color: "#3d0830" }}>
