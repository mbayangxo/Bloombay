    ...
    <div style={{ minHeight: "100vh", background: PAPER, paddingBottom: 96 }}>
      ...
      <div style={{
        ...
        <div style={{ padding: "0 20px", position: "relative", zIndex: 1 }}>
          ...
          <p style={{ fontFamily: "var(--font-caveat)", fontSize: 14, color: "rgba(255,255,255,0.75)", marginTop: 8 }}>{ALL_BLOOMIES.length} women in your world</p>
        </div>
      </div>
        ...
        {filtered.map(b => (
          <button key={b.name} onClick={() => setSelected(b)}
            ...
            <div style={{ flex: 1 }}>
              ...
              <p style={{ fontFamily: "var(--font-jost)", fontSize: 10, color: "rgba(0,0,0,0.4)", marginTop: 2 }}>{b.neighborhood} · since {b.since}</p>
            </div>
            <div style={{ textAlign: "right" as const }}>
              <p style={{ fontFamily: "var(--font-jost)", fontSize: 9, fontWeight: 700, color: PINK }}>{b.mutual} events</p>
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="rgba(255,31,125,0.3)" strokeWidth="2" strokeLinecap="round" style={{ marginTop: 4 }}><polyline points="9 18 15 12 9 6"/></svg>
            </div>
          </button>
        ))}
