...
export function LandingPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: IVORY, fontFamily: "var(--font-jost)" }}>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 24px", height: 64, display: "flex", alignItems: "center", justifyContent: "space-between", gap: 24 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <Link href="/waitlist" style={{ display: "flex", alignItems: "center", gap: 8, padding: "10px 22px", borderRadius: 999, fontSize: "10px", fontWeight: 900, letterSpacing: "0.12em", color: "white", background: `linear-gradient(135deg,${PINK},#c4005a)`, textDecoration: "none", boxShadow: "0 4px 16px rgba(255,31,125,0.35)" }}>
              JOIN WAITLIST <svg width="11" height="11" viewBox="0 0 12 12" fill="none"><path d="M2 6h8M6 2l4 4-4 4" stroke="white" strokeWidth="1.6" strokeLinecap="round" /></svg>
            </Link>
          </div>
        </div>
      </nav>
      ...
      {/* ══════════════════════════════════════════════════════
          MOBILE HERO — full screen, editorial cover feel
      ══════════════════════════════════════════════════════ */}
      <section className="bb-mobile-only" style={{ height: "100svh", background: PINK, flexDirection: "column", overflow: "hidden", position: "relative" }}>

        {/* Subtle texture overlay */}
        <div style={{ position: "absolute", inset: 0, backgroundImage: "radial-gradient(circle at 80% 20%, rgba(255,255,255,0.08) 0%, transparent 50%), radial-gradient(circle at 10% 80%, rgba(0,0,0,0.12) 0%, transparent 50%)", pointerEvents: "none", zIndex: 0 }} />
        ...
        <div style={{ position: "relative", zIndex: 1, flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", padding: "0 22px" }}>
          ...
          {/* Eyebrow */}
          <p style={{ fontFamily: "var(--font-jost)", fontSize: "8px", fontWeight: 800, letterSpacing: "0.36em", color: "rgba(255,255,255,0.45)", marginBottom: 22 }}>
            ✦ &nbsp;NEW YORK CITY &nbsp;·&nbsp; EST. 2025
          </p>

          {/* Headline — editorial mixed type */}
          <div style={{ marginBottom: 28 }}>
            {/* "Your" — italic Fraunces, large */}
            <div style={{ fontFamily: "var(--font-fraunces)", fontStyle: "italic", fontWeight: 300, fontSize: "clamp(52px, 15vw, 68px)", color: "white", lineHeight: 0.95, letterSpacing: "-0.01em" }}>
              Your
            </div>
            {/* "table" — Jost black, huge */}
            <div style={{ fontFamily: "var(--font-jost)", fontWeight: 900, fontSize: "clamp(72px, 21vw, 96px)", color: "white", lineHeight: 0.85, letterSpacing: "-0.04em" }}>
              table
            </div>
            {/* "is here." — outlined, same huge */}
            <div className="bb-outline" style={{ fontFamily: "var(--font-jost)", fontWeight: 900, fontSize: "clamp(64px, 18vw, 88px)", lineHeight: 0.9, letterSpacing: "-0.04em" }}>
              is here.
            </div>
          </div>

          {/* One-liner */}
          <p style={{ fontFamily: "var(--font-playfair)", fontStyle: "italic", fontSize: "15px", color: "rgba(255,255,255,0.65)", lineHeight: 1.6, marginBottom: 32 }}>
            New York City&apos;s social club for women.
          </p>

          {/* Mini event strip */}
          <div style={{ display: "flex", gap: 8, marginBottom: 32 }}>
            {["Dinner Society", "Museum Girls", "Book Club"].map((name) => (
              <div key={name} style={{ background: "rgba(255,255,255,0.12)", border: "1px solid rgba(255,255,255,0.2)", borderRadius: 999, padding: "5px 12px", backdropFilter: "blur(8px)" }}>
                <span style={{ fontSize: "9px", fontWeight: 700, letterSpacing: "0.08em", color: "rgba(255,255,255,0.8)" }}>{name}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{ position: "relative", zIndex: 1, padding: "0 20px", paddingBottom: "calc(env(safe-area-inset-bottom, 0px) + 28px)", flexShrink: 0 }}>
          <Link href="/waitlist" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", background: "white", borderRadius: 18, padding: "18px 22px", textDecoration: "none", boxShadow: "0 12px 40px rgba(0,0,0,0.22)", marginBottom: 12 }}>
            <div>
              <p style={{ fontFamily: "var(--font-jost)", fontSize: "13px", fontWeight: 900, letterSpacing: "0.08em", color: INK }}>JOIN THE WAITLIST</p>
              <p style={{ fontFamily: "var(--font-playfair)", fontStyle: "italic", fontSize: "11px", color: "#aaa", marginTop: 1 }}>500 founding spots available</p>
            </div>
      ...
      <section className="bb-desktop-only" style={{ minHeight: "91vh", background: IVORY, position: "relative", overflow: "hidden", gridTemplateColumns: "1fr 1fr", alignItems: "center", maxWidth: 1280, margin: "0 auto", padding: "48px 24px 64px", gap: 32 }}>
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          <h1 style={{ margin: "0 0 24px", lineHeight: 0.88 }}>
            <span style={{ display: "block", fontFamily: "var(--font-fraunces)", fontStyle: "italic", fontWeight: 300, fontSize: "clamp(50px, 8vw, 82px)", color: "white", letterSpacing: "-0.01em", lineHeight: 0.9 }}>Your</span>
            <span style={{ display: "block", fontFamily: "var(--font-jost)", fontWeight: 900, fontSize: "clamp(60px, 10vw, 108px)", color: "white", letterSpacing: "-0.04em", lineHeight: 0.84 }}>table</span>
            <span style={{ display: "block", fontFamily: "var(--font-jost)", fontWeight: 900, fontSize: "clamp(54px, 9vw, 96px)", color: "white", letterSpacing: "-0.04em", lineHeight: 0.9 }}>is here.</span>
          </h1>
          <div style={{ width: 36, height: 2, background: "rgba(255,255,255,0.35)", marginBottom: 20 }} />
          <p style={{ fontFamily: "var(--font-playfair)", fontStyle: "italic", fontSize: "18px", color: "rgba(255,255,255,0.65)", lineHeight: 1.6, maxWidth: 320, marginBottom: 36 }}>
            New York City&apos;s social club for women. Clubs, dinners, museums, and real friendship.
          </p>
          <div style={{ display: "flex", gap: 12 }}>
            <Link href="/waitlist" style={{ padding: "16px 36px", borderRadius: 999, fontWeight: 900, fontSize: "12px", letterSpacing: "0.14em", background: "white", color: PINK, textDecoration: "none", boxShadow: "0 8px 24px rgba(0,0,0,0.14)" }}>JOIN THE WAITLIST</Link>
      ...
      {/* ══════════════════════════════════════════════════════
          TONIGHT — visible on all sizes
      ══════════════════════════════════════════════════════ */}
      <section style={{ padding: "72px 22px", background: "white" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <h2 style={{ fontSize: "clamp(24px,3.5vw,36px)", fontWeight: 900, color: INK, marginBottom: 8 }}>
            Tonight on{" "}
            <span style={{ color: PINK, fontFamily: "var(--font-playfair)", fontStyle: "italic", fontWeight: 400 }}>BloomBay</span>
            {" "}<Sparkle />
          </h2>
          <p style={{ fontSize: "13px", color: "#aaa", fontWeight: 500, marginBottom: 28 }}>Real plans. Real women. Real memories.</p>
          <div style={{ display: "flex", gap: 18, overflowX: "auto", paddingBottom: 8 }}>
            {TONIGHT.map((ev) => (
              <div key={ev.id} style={{ flexShrink: 0, width: 210, borderRadius: 22, overflow: "hidden", boxShadow: "0 4px 20px rgba(0,0,0,0.08)", background: "white" }}>
                <div style={{ height: 200, background: ev.grad, position: "relative" }}>
                  ...
                  <div style={{ position: "absolute", top: 14, left: 14, padding: "5px 11px", borderRadius: 999, background: "rgba(255,255,255,0.95)", fontSize: "9px", fontWeight: 900, letterSpacing: "0.1em", color: PINK }}>
                    {ev.tag}
                  </div>
            ...
            <div style={{ flexShrink: 0, width: 120, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 14 }}>
              <p style={{ fontFamily: "var(--font-playfair)", fontStyle: "italic", color: "#ccc", fontSize: "18px", lineHeight: 1.3, textAlign: "center" }}>And more tonight.</p>
      ...
      {/* ══ TESTIMONIAL ══ */}
      <section style={{ padding: "72px 22px", background: IVORY }}>
        <div style={{ maxWidth: 860, margin: "0 auto" }}>
          <div style={{ borderRadius: 28, padding: "clamp(36px,6vw,64px)", background: INK, position: "relative", overflow: "hidden" }}>
            ...
            <div style={{ position: "relative" }}>
              ...
              <blockquote style={{ fontFamily: "var(--font-playfair)", fontStyle: "italic", fontSize: "clamp(18px,3vw,28px)", color: "white", lineHeight: 1.55, fontWeight: 400, margin: "22px 0 28px" }}>
      ...
      <section style={{ padding: "72px 22px", background: "white" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <h2 style={{ fontSize: "clamp(26px,4vw,42px)", fontWeight: 900, color: INK, marginBottom: 8, textAlign: "center" }}>
            Clubs that feel like{" "}
            <span style={{ color: PINK, fontFamily: "var(--font-playfair)", fontStyle: "italic", fontWeight: 400 }}>home.</span>
          </h2>
          <div style={{ width: 36, height: 2, background: PINK, margin: "0 auto 14px" }} />
          <p style={{ fontSize: "13px", fontWeight: 500, color: "#aaa", marginBottom: 32, textAlign: "center" }}>Find your people. Build your world.</p>
      ...
      <section style={{ background: INK, padding: "88px 22px", position: "relative", overflow: "hidden", display: "flex", alignItems: "center", justifyContent: "center" }}>
        ...
        <div style={{ position: "relative", textAlign: "center", maxWidth: 580 }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.35)", fontSize: "13px", fontFamily: "var(--font-playfair)", fontStyle: "italic", marginBottom: 40 }}>500 founding spots. New York City.</p>
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "64px 22px 36px" }}>
          <div style={{ display: "flex", flexDirection: "column", gap: 28, marginBottom: 48, paddingBottom: 40, borderBottom: "1px solid #ecddd4" }}>
            <div>
              ...
              <p style={{ fontSize: "14px", color: "#888", fontFamily: "var(--font-playfair)", fontStyle: "italic", marginBottom: 4 }}>A world built for women.</p>
