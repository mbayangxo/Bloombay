...
import { MOCK_LISTINGS, MOCK_SEEKERS, MOCK_QUIZ, type MockListing, type MockSeeker } from "@/lib/girlmate/mock-data";
...
type Seeker  = MockSeeker;

// Re-export mock data under legacy names so the rest of the component works unchanged
const LISTINGS = MOCK_LISTINGS;
const SEEKERS  = MOCK_SEEKERS;
